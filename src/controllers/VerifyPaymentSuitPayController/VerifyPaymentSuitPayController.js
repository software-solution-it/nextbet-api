...
exports.verify_payment_suitpay = async function (req, res) {
    ...
    if (body.transactionType === "RECEIVEPIX") {
        ...
        if (payment_record_trade) {
            ...
            if (payment_record_trade.transaction_id_suitpay === body.transactionId && payment_record_trade.state === 361) {
