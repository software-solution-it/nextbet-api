...
const InsertTransactions = require('./Model/Mysql/Insert/InsertTransactions/InsertTransactions');
...
exports.gamecallback = async function (req, res) {
    ...
    const select_game_aggregation_keys = await SelectGamesAgregationKeys();

    if (obj_recebido.agent_code === select_game_aggregation_keys.agentCode && obj_recebido.agent_secret ===
